...
export const Events = () =>
    <div>
        <div>
            <div style={{ fontSize: '10vw', fontFamily: 'Poppkorn', textAlign: 'center', marginBottom: 64 }}>Optiphonic</div>
            <p>
                I perform visual art at festivals and music events around New Zealand. Inspired by music visualizers in winamp and iTunes, I create computer programs that transform audio data into visually pleasing stage projections. You can see more of my content <a href="https://instagram.com/optiphonic">on instagram</a>.
            </p>
